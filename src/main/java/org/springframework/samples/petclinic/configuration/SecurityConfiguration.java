...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/mecanicos").hasAnyAuthority("admin")
				.antMatchers("/mecanicos/**").hasAnyAuthority("admin")
				...
				.antMatchers("/citas").hasAnyAuthority("admin", "cliente","mecanico")
				.antMatchers("/citas/cliente").hasAnyAuthority("cliente")
				.antMatchers("/cita/delete/{citaId}").hasAnyAuthority("mecanico","admin")
				.antMatchers("/cita/**").hasAnyAuthority("cliente")
				...
				.antMatchers("/vehiculos/**").hasAnyAuthority("mecanico", "admin","cliente")
				...
				.antMatchers("/revisiones/**").hasAnyAuthority("admin","mecanico")
				.antMatchers("/revisiones/mecanico").hasAnyAuthority("mecanico")
				.antMatchers("/revisionesNoAsignadas").hasAnyAuthority("mecanico")
				...
				.antMatchers("/producto/**").hasAnyAuthority("admin")
				.antMatchers("/productos/**").hasAnyAuthority("admin")
				.antMatchers("/facturas/**").hasAnyAuthority("admin","cliente")
				.antMatchers("/factura/**").hasAnyAuthority("admin")
				.antMatchers("/facturasNoAbonadas").hasAnyAuthority("admin")
				.antMatchers("/estancias").hasAnyAuthority("admin", "mecanico")
				.antMatchers("/estancia/**").hasAnyAuthority("admin", "mecanico")
				.antMatchers("/estancias/**").hasAnyAuthority("admin", "mecanico")
